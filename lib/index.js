...
readFile('./android/app/src/main/res/values/strings.xml').then(function (data) {
  ...
  _commander2.default.version('2.1.5').arguments('<newName>').option('-b, --bundleID [value]', 'Set custom bundle identifier eg. "com.junedomingo.travelapp"').action(function (newName) {
    ...
    setTimeout(function () {
      (0, _filesToModifyContent.filesToModifyContent)(currentAppName, newName, projectName).map(function (file) {
    ...
    setTimeout(function () {
      readFile('./android/app/src/main/AndroidManifest.xml').then(function (data) {
        ...
        var javaFiles = ['MainActivity.java', 'MainApplication.java', 'SplashActivity.java'];
